    ...
    >
      ...
      <View className="flex-1 px-6 pt-16 pb-6 justify-center">
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.8}
          testID={isFormValid ? "signup-button-enabled" : "signup-button-disabled"}
          accessibilityLabel="Sign Up"
        >
          {isLoading ? (
            <ActivityIndicator color={colors.white} testID="signup-loading" />
          ) : (
            <Text
        ...
        <View className="flex-row justify-center mt-6">
          ...
          <TouchableOpacity onPress={onNavigateToLogin} testID="navigate-to-login">
